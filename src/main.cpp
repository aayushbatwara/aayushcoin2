...
uint256 hashGenesisBlock("0x4fe19442140abe8b28c5715d7cab5388ff1892b060b9080aa2a389e8acf408cd");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x6372eec41cb138d29a7ff9cbc32391ae337da1516bb52c91313d17ad4aad8d00");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Aayush batwara creates a coin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 20 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04024e3a59f5e933657ffd0b428b1be46023d21ff1220c5700ae825a1482c6eb32b96851f918b8940db9bbc344c17d923f150a5160da60442e115f36c6c0652bf4") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1534659957;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084872488;

        if (fTestNet)
        {
            block.nTime    = 1534659915;
            block.nNonce   = 385372263;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x5b76e55f845d093cf0030af8984ad51846514159b49d9d6f9ee2e5976956387d"));
        block.print();
